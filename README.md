...
* **Categorización:** Clasificación visual mediante colores según el tipo de tarea.
...
1.  **Clonar el repositorio:**
    ```bash
    git clone [https://github.com/byronrmrz/To-Do-ListApp.git](https://github.com/byronrmrz/To-Do-ListApp.git)
    ```
